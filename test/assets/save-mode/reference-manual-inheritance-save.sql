...
ALTER TABLE IF EXISTS referencesThemAll
    ADD COLUMN IF NOT EXISTS baseId NUMERIC NOT NULL REFERENCES BaseModel,
    ADD COLUMN IF NOT EXISTS oneId NUMERIC NOT NULL REFERENCES LevelOneModel,
    ADD COLUMN IF NOT EXISTS twoId NUMERIC NOT NULL REFERENCES LevelTwoModel;